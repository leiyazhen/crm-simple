...
<body>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<c:if test="${not empty customer.userid}">
									<a href="javascript:;" id="publicCustomer"
										class="btn btn-xs btn-warning pull-right"
										style="margin-left: 15px;">公开客户</a>
									<a href="javascript:;" id="tranCustomer"
						...
						<div class="row">
							<div class="col-lg-9 col-md-9">
								<div class="panel panel-default">
									<div class="panel-heading">
										跟进信息
										<button id="addProgress"
											class="btn btn-default btn-xs pull-right">
											<i class="fa fa-plus"></i> 添加跟进信息
										</button>
									</div>
									<div class="panel-body">
										...
										<c:forEach items="${progressList}" var="pro">
											...
											<div class="panel-body">${pro.mark}</div>
											<c:choose>
								...
								<div class="panel-body">
									<ul class="list-unstyled">
										...
										<c:forEach items="${taskList}" var="task">
											<li><input type="checkbox" rel="${task.id}"
												class="ckTask"> ${task.task}</li>
										</c:forEach>
	...
	<div class="modal fade" id="progressModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/customer/progress/new" method="post" id="newForm"
						enctype="multipart/form-data">
						<div class="form-group">
							<label>客户</label> <input type="hidden" value="${customer.id}"
								name="custid"> <input type="text" class="form-control"
								value="${customer.contact}" disabled>
						</div>
						<div class="form-group">
							<label>选择进度</label> <select name="progress" class="form-control">
	...
	<script>
		$(function() {
			...
			<c:if test="${not empty customer.userid}">
			//公开客户
			$("#publicCustomer").click(
					function() {
						if (confirm("客户公开后，所有的用户都可以看到该客户的信息,确定吗")) {
							$.post("/customer/public/${customer.id}").done(
									function(result) {
			...
			$("#tranBtn").click(
					function() {
						...
						if (userId) {
							$.post("/customer/tran/${customer.id}/" + userId)
			...
			$(".ckTask").click(function() {
				...
				$.post("/customer/change/taskstate", {
					"taskId" : id,
					"state" : "true"
				}).done(function(result) {
					if (result == "success") {
